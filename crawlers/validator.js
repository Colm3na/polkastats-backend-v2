...
async function main () {
  ...
  validatorStaking.forEach(validator => {
    validator.sessionIdsHex = validator.sessionIds.length !== 0 ? validator.sessionIds.toHex() : ``;
    validator.nextSessionIdsHex = validator.nextSessionIds.length !== 0 ? validator.nextSessionIds.toHex() : ``;
  })
